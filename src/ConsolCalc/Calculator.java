...
public class Calculator
{
    public static void main(String[] args)
    {
        ...
        String operation;
        System.out.println("Выберете одну из операций: +, -, *, /, log, ln, sin, cos");
        System.out.println("Пример: 'цифра-пробел-знак-пробел-цифра' иначе вдыаст ошибку!");
        System.out.println("Введите выражение по примеру или 'exit' для выхода:");
        while (true)
        {
            System.out.print("> ");
